 ...
 */
export default joint.ui.SelectionView.extend({
        ...
        switch (this._action) {
            ...
            case 'translating':
                ...
                if (dx || dy) {
                    ...
                    var paperScale = joint.V(this.options.paper.viewport).scale();
                    dx *= paperScale.sx;
                    dy *= paperScale.sy;
    ...
    stopSelecting: function (evt) {
        ...
        switch (this._action) {
            ...
            case 'selecting':
                ...
                var localPoint = joint.V(this.options.paper.svg).toLocalPoint(offset.left, offset.top);
    ...
    startRotateElements: function (evt) {
        ...
        this._rotationStart = joint.g.point(evt.offsetX + evt.target.parentNode.offsetLeft, evt.offsetY + evt.target.parentNode.offsetTop + evt.target.parentNode.offsetHeight);
    ...
    rotateElements: function (evt) {
        ...
        var p = joint.g.point(this._rotationStart).offset(dx, dy);
        ...
        angleDiff = joint.g.snapToGrid(angleDiff, 15);
    ...
    findViewsInAreaInclusive: function (r) {
        ...
        return _.filter(views, function (view) {
            return r.containsRect(g.rect(joint.V(view.el).bbox(false, this.viewport)));
        }, this);
