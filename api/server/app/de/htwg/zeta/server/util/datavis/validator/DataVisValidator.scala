...
import de.htwg.zeta.server.util.domain.MAttribute
import de.htwg.zeta.server.util.domain.MAttributeBoolean
import de.htwg.zeta.server.util.domain.MAttributeMEnumNumber
import de.htwg.zeta.server.util.domain.MAttributeMEnumString
import de.htwg.zeta.server.util.domain.MAttributeNumber
import de.htwg.zeta.server.util.domain.MAttributeString
import de.htwg.zeta.server.util.domain.MEnumNumber
import de.htwg.zeta.server.util.domain.MEnumString
