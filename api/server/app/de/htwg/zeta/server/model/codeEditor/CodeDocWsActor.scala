...
object CodeDocWsActor {
  def props(out: ActorRef, docManager: ActorRef, metaModelId: UUID, dslType: String, metaModelEntityRepo: MetaModelEntityRepository): Props = {
...
class CodeDocWsActor(
    ...
    metaModelId: UUID,
    dslType: String,
    metaModelEntityRepo: MetaModelEntityRepository
