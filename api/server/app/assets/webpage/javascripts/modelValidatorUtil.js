...
var modelValidatorUtil = (function ($) {
    ...
    show = function (metaModelId, options) {
        ...
        $.ajax({
            type: 'GET',
            url: '/rest/v1/meta-models/' + metaModelId + '/validator?generate=false&noContent=false',
            success: function (data, textStatus, jqXHR) {
    ...
    generate = function (metaModelId, options) {
        $.ajax({
            type: 'GET',
            url: '/rest/v1/meta-models/' + metaModelId + '/validator?generate=true&noContent=true',
            success: function (data, textStatus, jqXHR) {
