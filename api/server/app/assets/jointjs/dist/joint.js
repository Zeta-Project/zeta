...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(['backboneNew', 'lodash', 'jquery'], function(backboneNew, _, $) {

            backboneNew.$ = $;

            return factory(root, backboneNew, _, $);
        });
        ...
        var backboneNew = require('backboneNew');
        var _ = require('lodash');
        var $ = backboneNew.$ = require('jquery');

        module.exports = factory(root, backboneNew, _, $);

    } else {

        // As a browser global.

        var backboneNew = root.backboneNew;
        var _ = root._;
        var $ = backboneNew.$ = root.jQuery || root.$;

        root.joint = factory(root, backboneNew, _, $);
        root.g = root.joint.g;
        root.V = root.Vectorizer = root.joint.V;
    }

}(this, function(root, backboneNew, _, $) {
...
joint.dia.GraphCells = backboneNew.Collection.extend({

    cellNamespace: joint.shapes,

    initialize: function(models, opt) {

        // backboneNew automatically doesn't trigger re-sort if models attributes are changed later when
...
joint.dia.Graph = backboneNew.Model.extend({
    ...
    initialize: function(attrs, opt) {
        ...
        backboneNew.Model.prototype.set.call(this, 'cells', new joint.dia.GraphCells([], {
            model: opt.cellModel,
    ...
    toJSON: function() {
        ...
        // backboneNew does not recursively call `toJSON()` on attributes that are themselves models/collections.
        // It just clones the attributes. Therefore, we must call `toJSON()` on the cells collection explicitely.
        var json = backboneNew.Model.prototype.toJSON.apply(this, arguments);
    ...
    set: function(key, val, opt) {
        ...
        return backboneNew.Model.prototype.set.call(this, attrs, opt);
    },
    ...
    _prepareCell: function(cell) {
        ...
        var attrs = (cell instanceof backboneNew.Model) ? cell.attributes : cell;
...
joint.dia.Cell = backboneNew.Model.extend({

    // This is the same as backboneNew.Model with the only difference that is uses _.merge
    ...
    clone: function(opt) {
        ...
        var clone = backboneNew.Model.prototype.clone.apply(this, arguments);
...
joint.dia.CellView = backboneNew.View.extend({
    ...
    constructor: function(options) {
        ...
        backboneNew.View.apply(this, arguments);
    },
    ...
    // Override the backboneNew `_ensureElement()` method in order to create a `<g>` node that wraps
    ...
    _setElement: function(el) {
        this.$el = el instanceof backboneNew.$ ? el : backboneNew.$(el);
        this.el = this.$el[0];
        this.vel = V(this.el);
    },
...
joint.dia.Paper = backboneNew.View.extend({
    ...
    options: {
        ...
        // Value could be the backboneNew.model or a function returning the backboneNew.model
    ...
    remove: function() {
        ...
        backboneNew.View.prototype.remove.call(this);
    },
    ...
    createViewForModel: function(cell) {
        ...
        var ViewClass = (optionalViewClass.prototype instanceof backboneNew.View)
    ...
    getDefaultLink: function(cellView, magnet) {
        ...
        // default link is the backboneNew model
