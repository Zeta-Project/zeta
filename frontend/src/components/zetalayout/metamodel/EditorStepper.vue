        ...
        <v-toolbar dark color="primary" class="rounded-0">
          ...
          <v-toolbar-items>
            <v-stepper v-model="currentStep" class="elevation-0 rounded-0">
              <v-stepper-header>
                <v-stepper-step class="stepper-step-hover" @click="setCurrentStep(1)" :complete="isConceptStepCompleted"
                                step="1">
                  <span class="stepper-step-hover-text">{{ step1 }}</span>
                </v-stepper-step>
                <v-divider></v-divider>
                <v-stepper-step class="stepper-step-hover" @click="setCurrentStep(2)" :complete="isShapeStepCompleted"
                                step="2">
                  <span class="stepper-step-hover-text">{{ step2 }}</span>
                </v-stepper-step>
                <v-divider></v-divider>
                <v-stepper-step class="stepper-step-hover" @click="setCurrentStep(3)" :complete="isStyleStepCompleted"
                                step="3">
                  <span class="stepper-step-hover-text">{{ step3 }}</span>
                </v-stepper-step>
                <v-divider></v-divider>
                <v-stepper-step class="stepper-step-hover" @click="setCurrentStep(4)" :complete="isDiagramStepCompleted"
                                step="4">
...
<script>
import GraphEditor from "@/components/zetalayout/metamodel/graphical-editor/components/graphEditor/GraphEditor";
